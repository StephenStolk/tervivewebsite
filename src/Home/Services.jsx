  ...
  return (
    <section className="bg-gray-50 py-28">
      ...
      <div className="flex flex-col items-center md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-8 mb-28">
        {/* First Card */}
        <motion.div
          className="relative bg-white p-6 rounded-lg shadow-md w-80 h-80 md:w-72 md:h-72 flex flex-col justify-between"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.2 }}
        >
          <div>
            <div className="rounded-full w-12 h-12 flex items-center justify-center mb-6 ml-4">
        ...
        <motion.div
          ...
          style={{ marginTop: '4rem' }} // Adjust vertical position
        >
          <div>
            <div className="w-16 h-12 flex items-center justify-center mb-6">
              <img src="https://png.pngtree.com/png-vector/20221201/ourmid/pngtree-credit-manager-icon-with-male-worker-and-bank-building-vector-png-image_42976226.jpg" alt="Icon" />
            </div>
        ...
        <motion.div
          ...
          style={{ marginTop: '2rem' }} // Adjust vertical position
        >
          <div>
        ...
        <motion.div
          ...
          style={{ marginTop: '6rem' }} // Adjust vertical position
        >
          <div>
